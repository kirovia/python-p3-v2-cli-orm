...
def find_department_by_id():
    id_ = input('Enter the ID of the department: ')
...
def update_department():
    ...
    if department := Department.find_by_id(id_):
        try:
            ...
            location = input('Enter the new location of the department: ')
...
def delete_department():
    id_ = input('Please input the ID of the department: ')
    if department := Department.find_by_id(id_):
        department.delete()
